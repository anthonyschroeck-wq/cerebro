  ...
  const renderLanding = () => (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", position: "relative", zIndex: 1, padding: "40px 20px" }}>
      <div style={{ marginBottom: 48, textAlign: "center" }}>
        <div style={{ fontFamily: T.fontDisplay, fontSize: 38, color: T.text, letterSpacing: 4, marginBottom: 8 }}><img src="/cerebro-logo.svg" alt="Cerebro" style={{ width: 360, height: 360 }} /></div>
  ...
  const renderLayer1 = () => (
    <div style={{ minHeight: "100vh", position: "relative", zIndex: 1, padding: "32px 40px", maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 32 }}>
        ...
        <img src="/cerebro-logo.svg" alt="Cerebro" style={{ width: 96, height: 96 }} />
